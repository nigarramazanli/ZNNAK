...
import { GridDefaultListItem } from './GridDefaultListItem';
...
import grid from './components/photo/clarity_grid-view-solid.png';
import headphones from './components/photo/1111.png';
import list from './components/photo/fa-solid_list.svg';
          ...
          <div className="right">
            ...
            <div className="view">
              ...
              <div className="icons-grid">
                <button onClick={setListMode}>
                  <img src={list} alt="" />
                </button>
                <button onClick={setGridMode}>
                  <img src={grid} alt="" />
                </button>
              </div>
            </div>
