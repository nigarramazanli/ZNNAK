...
import item from './vector-2.png';
import tortuga from './tortuga-01-b 1.png';
        ...
        <div className="discount-general">
            ...
            <div className='Products-sofa'>
                <div className='products'>
                    ...
                    <p className='n3'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu eget<br/> feugiat habitasse nec, bibendum condimentum.</p>
